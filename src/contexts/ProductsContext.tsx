...
const defaultProducts: Product[] = [
  ...
  },
  {
    ...
    description: 'Cargador dual USB-C con 50W de potencia total para iPhone 15 Pro Max. Revisado y aprobado por el técnico, con IC de carga inteligente.',
