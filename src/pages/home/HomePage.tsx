  ...
  return (
    <>
      ...
      >
        ...
        {/* Glow orbs */}
        <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-cyan-500/5 rounded-full blur-3xl animate-float" aria-hidden="true" />
        <div className="absolute bottom-1/3 right-1/4 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-3xl animate-float delay-300" aria-hidden="true" />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            {/* Profile Avatar */}
            <div className="flex justify-center mb-6 animate-fade-in-up delay-[50ms]">
              <div className="relative w-32 h-32 sm:w-40 sm:h-40 rounded-full border-4 border-cyan-500/30 overflow-hidden shadow-[0_0_40px_rgba(6,182,212,0.15)] group">
                <img 
            ...
            <h1
              id="home-hero-title"
              className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-tight mb-6 animate-fade-in-up delay-100"
            >
              <span className="gradient-text-brand">ALEJ_TECH</span>
            </h1>

            <p className="text-xl sm:text-2xl text-slate-300 leading-relaxed max-w-2xl mx-auto mb-4 animate-fade-in-up delay-200">
          ...
          {/* ── TWO MAIN CTAs ── */}
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto animate-fade-in-up delay-400">

            {/* TIENDA CARD */}
            <button
              onClick={() => navigate('/tienda')}
              className="group relative p-8 lg:p-10 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-cyan-500/40 transition-all duration-500 text-left overflow-hidden card-hover-cyan"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-white mb-3 group-hover:text-cyan-50 transition-colors">
                  Tienda Virtual
                </h2>
            ...
            <button
              ...
              className="group relative p-8 lg:p-10 rounded-2xl bg-slate-900/60 border border-slate-800 hover:border-purple-500/40 transition-all duration-500 text-left overflow-hidden card-hover-purple"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-white mb-3 group-hover:text-purple-50 transition-colors">
                  Servicio Técnico
                </h2>
                <p className="text-base text-slate-400 mb-6 leading-relaxed">
